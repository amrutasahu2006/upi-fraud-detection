...
const { getAllUsers, getUserById, updateUserRole, deleteUser, toggleUserStatus, getFraudHotspots, getFraudStats, getRecentFraudActivity } = require('../controllers/adminController');
